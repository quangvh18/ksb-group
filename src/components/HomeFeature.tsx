    ...
    <section className="bg-white py-12 md:py-16" data-aos="fade-up">
      <div className="container mx-auto px-4 md:px-5 max-w-[1300px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div className="relative order-2 lg:order-1" data-aos="fade-right" data-aos-delay="150">
          ...
          <div className="order-1 lg:order-2" data-aos="fade-left" data-aos-delay="200">
            <h2 className="text-4xl md:text-5xl font-bold text-muted-foreground mb-5">
